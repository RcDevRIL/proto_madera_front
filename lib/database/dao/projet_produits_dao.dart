...
import 'package:proto_madera_front/database/tables/projet_produits.dart';

part 'projet_produits_dao.g.dart';

@UseDao(tables: [ProjetProduits])

class ProjetProduitsDao extends DatabaseAccessor<MaderaDatabase> with _$ProjetProduitsDaoMixin {
