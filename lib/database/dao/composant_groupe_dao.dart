...
import 'package:proto_madera_front/database/tables/composant_groupe.dart';

part 'composant_groupe_dao.g.dart';

@UseDao(tables: [ComposantGroupe])

class ComposantGroupeDao extends DatabaseAccessor<MaderaDatabase> with _$ComposantGroupeDaoMixin {
